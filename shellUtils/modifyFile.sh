...
{  
  ...
  do  
    ...
    if [ -d $path ];then
      ...
      cp -rf $(dirname ${path})"/" /Users/lilili/Documents/juphoon/vuepress/docs/cn/01_o2o_video/99_api_reference/01_server_api/  
      cp -rf $(dirname ${path})"/" /Users/lilili/Documents/juphoon/vuepress/docs/cn/02_mult_audio/99_api_reference/01_server_api/
      cp -rf $(dirname ${path})"/" /Users/lilili/Documents/juphoon/vuepress/docs/cn/03_mult_video/99_api_reference/01_server_api/ 
      cp -rf $(dirname ${path})"/" /Users/lilili/Documents/juphoon/vuepress/docs/cn/04_audio_live/99_api_reference/01_server_api/ 
      cp -rf $(dirname ${path})"/" /Users/lilili/Documents/juphoon/vuepress/docs/cn/05_video_live/99_api_reference/01_server_api/ 
    fi  
  done  
}
echo "compleat!"$count
